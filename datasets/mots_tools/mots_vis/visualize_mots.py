...
on the rootDir:
tracks_mot_pointtrack_val /home/ajin/Data/MOT17/train MOT_gt_tracking_0425 datasets/mots_tools/mots_eval/val_MOTSchallenge.seqmap
focal_resample_resplit_result_testset_0522 /home/ajin/Data/kitti/testing/image_02 kitti_testset_tracking datasets/mots_tools/mots_eval/test.seqmap
'''
        ...
        if t in tracks:
            for obj in tracks[t]:
                ...
                if obj.class_id == 1 or obj.class_id == 2:  # Don't show boxes or ids for ignore regions
                    ...
                    ax.annotate(category_name, (x + 0.5 * w, y -5), color=color, weight='bold',
