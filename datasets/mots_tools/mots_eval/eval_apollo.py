...
def print_summary(seq_names, results_per_seq, results_for_all_seqs, column_width=14):
    ...
    row_format = "{:>17}" + "".join([("{:>" + str(max(len(name), 4) + 2) + "}") for name in metrics_names])
...
'''
python -u eval.py /home/xubb/trackrcnn/forwarded/conv3d_sep2/tracking_data /home/xubb/Data/kitti/instances val.seqmap
'''