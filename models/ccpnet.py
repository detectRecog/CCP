'''
The train/evaluation code of ccpnet
'''
...
from models.erfnetGroupNorm import non_bottleneck_1d_gn, non_bottleneck_1d, DownsamplerBlock, ConvDownsampler
...
class PointTrackLightning(pl.LightningModule):
    ...
    def validation_epoch_end(self, validation_step_outputs):
        ...
        if self.global_rank == 0 and 'mots' in self.args['save_dir']:
            ...
            val_loss = float(ids_str) # record IDS by val_loss
            if len(acc_str) > 0:
